...
video.set(cv2.CAP_PROP_FRAME_HEIGHT, 1)
...
while video.isOpened():
    ...
    check=cv2.resize(frame,(int(width*0.125),int(height*0.125)))
    ...
    facerect = cascade.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=2, minSize=(5,5))
